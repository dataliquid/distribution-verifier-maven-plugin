...
public class JunitReportTest
{
    ...
    {
        // given
        String expectedReport = "src/test/resources/valid-fullmatch/report_junit.xml";
    ...
    {
        // given
        String expectedReport = "src/test/resources/valid-fullmatch-variables/report_junit.xml";
    ...
    {
        // given
        String expectedReport = "src/test/resources/invalid-missingfile/report_junit.xml";
    ...
    {
        // given
        String expectedReport = "src/test/resources/invalid-found-undefined-file/report_junit.xml";
    ...
    {
        // given
        String expectedReport = "src/test/resources/invalid-different-md5-checksum/report_junit.xml";
